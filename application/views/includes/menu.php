			...
			<ul class="nav navbar-nav navbar-right">
				...
				<?php if ($this->session->userdata['userinfo']['is_admin'] == 2) { ?>
					<li class="dropdown">
						<a aria-expanded="false" role="button" data-toggle="dropdown" class="dropdown-toggle" id="more" href="#">More <span class="caret"></span></a>
						<ul role="menu" class="dropdown-menu ">
							<li class=""><a href="<?= base_url('userList') ?>" target="_blank">Employee Listing</a></li>
						</ul>
					</li>
				<?php } ?>
	...
	$(document).ready(function() {
		$('#myNavbar .nav li').click(function() {
			...
			if (da == 'dashboard') {
				...
				setTimeout(function() {
					$('#Dealer_Listing').addClass('active');
				}, 30);
				...
				$('.abc').removeClass('active');
				setTimeout(function() {
					$('#Employee_Listing').addClass('active');
				}, 30);
			} else if (da == 'addUser') {
				$('.abc').removeClass('active');
				setTimeout(function() {
		...
		if (da == 'dashboard') {
			...
			$('.abc').removeClass('active');
			setTimeout(function() {
				$('#Delivery_Order').addClass('active');
			}, 30);
