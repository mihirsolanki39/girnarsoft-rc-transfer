                                    ...
                                    <div class="sec-card">
                                       ...
                                       <div class="tab-content">
                                          ...
                                          <div role="tabpanel" class="tab-pane active" id="upload">
                                              <style>
                                                  .pos-a-uc{position: absolute;  top: -63px;  right: -30px;}
                                             </style>
     ...
     //alert(countloop+'adededesd');
      // Dropzone.autoDiscover = false;
            var myDropzone = new Dropzone("form#demoUpload", {
                url: '<?php echo base_url(); ?>UsedCarSale/uploadLoginDocs/'+case_id+"-"+customer_id+"-"+'2',
           ...
           var myDropzone1 = new Dropzone("div#secUploadBtn", {
                url: base_url+'UsedCarSale/uploadLoginDocs/'+case_id+"-"+customer_id+"-"+'2',
                previewsContainer: '#preview',
                success: function(file, response){
                  $('img[alt="'+file.name+'"]').parent().siblings('.tag').attr('id',$.trim(response));
                  //$('img[alt="'+file.name+'"]').parent().siblings('.tag').attr('onclick','tagImages(this)');
      ...
      if(currID!='')
      {
       // alert('hii');
        ...
        return true;
          ...
          function imageTagging(eve)
          {
            ...
            if((currImgId>0) && (tagdocId>0))
            {
              ...
              dataType: 'json',
              data : {ImgID:currImgId,taggID:tagdocId,customer_id:customer_id,type:'add',case_id:case_id,subcat:subcatTagId[1],doctype:'disburse'},
          ...
          $('#removeTag').click(function(){
            ...
            $.ajax({
              type : 'POST',
              url : "<?php echo base_url(); ?>" + "UsedCarSale/loanTagMapping/",
              data : {ImgID:image_id,customer_id:customer_id,type:'remove',case_id:case_id,doctype:'disburse',},
              dataType: 'json',
              success: function (response) { 
                if(response.status)
                { 
         ...
         function updateCounter(tagId,type,classId)
          ...
          function appBank(tag_id,rel_id)
          {
              ...
              data : {type:'loan',customer_id:customer_id,tag_id:tag_id,case_id:case_id,doctype:'disburse'},
              success: function (response) { 
          ...
          function updateBank()
          {
            ...
            $.ajax({
              type : 'POST',
              url : "<?php echo base_url(); ?>" + "UsedCarSale/loanTagMapping/",
              data : {bank:bank,taggID:tag_id,ImgID:img_id,customer_id:customer_id,type:'bank',case_id:case_id,subcat:re[1],doctype:'disburse'},
              dataType: 'json',
              success: function (response) 
              { 
                 if(response.status=='1')
           ...
           function markIncorrect()
          {
            ...
            $.ajax({
              type : 'POST',
              url : "<?php echo base_url(); ?>" + "UsedCarSale/loanTagMapping/",
              data : {reason_id:reason,taggID:tag_id,ImgID:img_id,customer_id:customer_id,type:'markincorrect',case_id:case_id,doctype:'disburse'},
              dataType: 'json',
              success: function (response) 
              { 
           ...
           $("#category_id").change(function() {
            ...
            $.ajax({
              ...
              data : {catId:catId,doctype:6,case_id:case_id},
              dataType: 'html',
              success: function (response) 
              { 
           ...
           function getCategoryList()
           {
              ...
              type : 'POST',
              url : "<?php echo base_url(); ?>" + "UsedCarSale/pendencyByCatId/",
              data : {type:'getcategoryId',doctype:6,case_id:case_id},
              dataType: 'html',
              success: function (response) 
              { 
        ...
        function addPendency()
        {
          ...
          var category_id = $("#category_id").val();
           $.ajax({
                      ...
                      data : {case_id:case_id,doctype:6,pendencyId:pendencyId,category_id:category_id},
                      dataType: 'json',
                      success: function (response) 
                      { 
                        if(response.status=='1'){
        ...
        function downloadAll()
        {
          ...
          window.top.location.href = base_url+"UsedCarSale/getImagedownload/"+case_id+'/9';  
        }
