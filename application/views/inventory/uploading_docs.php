        ...
        <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="form-group mrg-B29">
                ...
                <div class="form-group fg-docs">
                    ...
                    <div>
                        <p class="doc-image-name"><?= isset($inventory_docs['rc_img_url']) ? end(explode('/', $inventory_docs['rc_img_url'])) : '' ?></p>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="form-group mrg-B29">
                ...
                <div class="form-group fg-docs">
                    ...
                    <label class="image-error-message"></label>
                    <div>
                        <p class="doc-image-name"><?= isset($inventory_docs['supporting_doc_1_url']) ? end(explode('/', $inventory_docs['supporting_doc_1_url'])) : '' ?></p>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="form-group mrg-B29">
                ...
                <div class="form-group fg-docs">
                    ...
                    <label class="image-error-message"></label>
                    <div>
                        <p class="doc-image-name"><?= isset($inventory_docs['supporting_doc_2_url']) ? end(explode('/', $inventory_docs['supporting_doc_2_url'])) : '' ?></p>
...
<style>
    ...
    .upload-doc.active.focus,
    .upload-doc.active:focus,
    .upload-doc.active:hover,
    .upload-doc:active.focus,
    .upload-doc:active:focus,
    .upload-doc:active:hover,
    .open>.dropdown-toggle.upload-doc.focus,
    .open>.dropdown-toggle.upload-doc:focus,
    .open>.dropdown-toggle.upload-doc:hover {
        background: #fff;
    ...
    .upload-doc:active,
    .upload-doc.active,
    .open>.dropdown-toggle.upload-doc {
        color: #fff;
    }
