<link rel="stylesheet" href="http://honda-auto-terrace.com/admin/sort/sort.css" />
...
<style>
  ...
  .browse-bg{
    background:#eee url(http://honda-auto-terrace.com/admin/images/browse-bg.png) no-repeat center center !important;
  }

  .browse-more{
    background:#eee url(http://honda-auto-terrace.com/admin/images/browse.png) no-repeat bottom right !important;
  }
...
<link rel="stylesheet" href="http://honda-auto-terrace.com/admin/css/jquery.fileupload-ui.css" />
...
<div class="middle"> 
  ...
  <form id="fileupload" action="//jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">
    ...
    <?php if(empty($selectedData)  && count($getImageinedit)==0){ ?>
        <ul class="files browse-bg"  id="testing" style="margin-top:1px;" data-toggle="modal-gallery" data-target="#modal-gallery" onclick="_gaq.push(['_trackEvent','Add Inventory','Select-Browse', '<?php echo $event_type; ?>'])"></ul>
    <?php } else { ?>
      <ul class="files browse-more" id="testing" data-toggle="modal-gallery" data-target="#modal-gallery" onclick="_gaq.push(['_trackEvent','Add Inventory','Select-Browse', '<?php echo $event_type; ?>'])"></ul>
    <?php } ?>
    </table>
  </form>
</div>
<?php $ImageUpdateStatus=1; $isImageUpdateAllowed = '2'; ?>
...
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/jquery.min.js"></script>
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/jquery-ui.min.js"></script>
<!-- The Templates plugin is included to render the upload/download listings -->
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/tmpl.min.js"></script>
<!-- The Load Image plugin is included for the preview images and image resizing functionality -->
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/load-image.min.js"></script>
<!-- The Canvas to Blob plugin is included for image resizing functionality -->
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/canvas-to-blob.min.js"></script>
<!-- jQuery Image Gallery -->
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/jquery.image-gallery.min.js"></script>
<!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/jquery.fileupload.js"></script>
<!-- The File Upload file processing plugin -->
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/jquery.fileupload-fp.js"></script>
<!-- The File Upload user interface plugin -->
<?php if($dealerType!='1'){?>
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/jquery.fileupload-ui.js?343243244"></script>

<?php } else {?>
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/jquery.fileupload-ui1.js?3243243244"></script>
<?php } ?>
<!-- The File Upload jQuery UI plugin -->
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/jquery.fileupload-jui.js"></script>
<!-- The main application script -->

<?php if($ie!='1'){?>
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/main.js"></script>
<?php } else {?>
<script src="http://honda-auto-terrace.com/admin/imageuploader_new/js/main1.js"></script>
<?php } ?>
...
window.parent.$('#Preview').show();
  ...
  $(".setprofile").click(function(){
    ...
    if(value!=undefined)
    {
      $.ajax({
        type: "POST",
        url: "setprofile.php?value="+value,
        data: "",
        dataType:"html",
           beforeSend: function () {
