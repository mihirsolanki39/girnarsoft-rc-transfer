...
/*FORM*/
            ...
            .left-menu .navbar-nav>li>a {padding-top: 10px;padding-bottom: 10px; margin: 0px 10px 0px 0px;border-bottom: 3px solid transparent !important;}
             ...
             .nav-tabs>li>a:hover {border-color: transparent;}
              ...
              .col-black-t{color: #000000; opacity: 0.87; font-size: 22px}
              .col-yellow{color:#FBC100;}
              rect.highcharts-point.highcharts-color-0 {fill: #BFEB9F;}
              tspan { fill: #000000;opacity: .54;}
          ...
          <div class="col-md-12">
           ...
           <div class="row">
            <div class="col-md-12 mrg-T20">
              <div class="row">
                <div class="col-md-6 pad-L0"><h1 class="col-black-t">Performance</h1></div>
                <div class="col-md-6 pad-R0">
