    ...
    <div class="modal-body" style="height: 660px; overflow-y: scroll;">
        ...
        <div class="clearfix" style="padding-top:10px">
            <div class="row">
                 ...
                 <div class="col-md-3 pull-right text-right">Total Amount : <i class="fa fa-rupee"></i><span id="tot_amt"><?= $paymentDetails['total_amount'] ?></span></div>
                    ...
                    <div class="col-md-3" style="height:84px">
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="dp2">
                                <input type="text" class="form-control payment_date crm-form crm-form_1" id="paydates" name="paydate" autocomplete="off" value="<?= (!empty($paymentDetails['payment_date']) ? date('d-m-Y', strtotime($paymentDetails['payment_date'])) : '') ?>" readonly placeholder="Payment Date">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="dp" style="width:100%">
                                <div class="input-group date" id="dp1">
                                    ...
                                    ?>
                                    <input type="text" class="form-control crm-form insdate crm-form_1" id="insdates" name="insdate" autocomplete="off" value="<?= $instrument_date ?>" readonly placeholder="Instrument Date">
                                    <span class="input-group-addon">
                                        <span class="">
                                            <img src="<?php echo base_url(); ?>assets/admin_assets/images/fltr-calendar.svg">
                                        </span>
