        ...
        <form id="payout_search_form" name="payout_search_form" method="post">
            ...
            <div class="row">
                <div class="col-md-2 pad-R0">
                    ...
                    <div class="select-box cus-selec" style="width:80px" id="payment_search" >Select <span class="d-arrow"></span></div>
                    <ul class="drop-menu">
                        <li><a href="#" onclick="searchby(this)" id="searchsl">S.No.</a></li>
                ...
                <div class="col-md-2 pad-R0">
                    <span id="spnsearch">
                        ...
                        <a href="JavaScript:Void(0)" onclick="reset(1)" id="Reset" class="btn-reset">RESET</a>
                                ...
                                <div class="row">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover enquiry-table myLoantbl">
                                                ...
                                                if (!empty($payout_history)) {
                                                    ...
                                                    foreach ($payout_history as $key => $value) {
                                                        ...
                                                        <tr class="hover-section">
                                                            ...
                                                            <td style="position:relative">                                                                                                                                                                 
                                                <div class="mrg-B5"><?= (!empty($value['bank_name']) &&  ($value['payment_mode'] == 2  || $value['payment_mode'] == 3)) ? $value['bank_name'] : "" ?></div>                                                                        
                                                            </td>
                                                            <td style="position:relative">                                                                                                                                                                 
                                           ...
                                           echo "<tr><td align='center' colspan='11'><div class='text-center pad-T30 pad-B30'><img src='".base_url()."assets/admin_assets/images/NoRecordFound.png'></div></td></tr>"; }?>
  ...
  function dealerList()
        {
           ...
           { 
            ...
            document.getElementById('payout_search_form').addEventListener('keypress', function(event) {
              if (event.keyCode == 13) {
                  $("#payouthistorysearch").click();
              }
          });


          /*  function downloadFile(id){
    window.top.location.href = base_url+"payoutInsurance/printPayoutpdf/" + id; 
}*/
    function downloadFile(id){
        $.ajax({
        type: 'POST',
