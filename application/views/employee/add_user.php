                        ...
                        <div class="padLR23 clearfix">
                            ...
                            <div class="row">
			                    ...
			                    $b['']='Select Team';
                                            ...
                                            $team_id= $b;
                                         echo form_dropdown('team_id', $team_id,set_value('team_id',!empty($empInfo[0])?$empInfo[0]['team_id']:''),'class="form-control customize-form testselect1", data-field-name = "Team",  id="team_id"');
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <select class="form-control customize-form role_select" data-field-name = 'Role Assignment'  name="role_id" id="role_id">
                                ...
                                <div id="showAddLimit" style="display: none;">
                                    <div class="row" id="add_field_button"> 
                                         <div class="col-md-3"><h4 class="mrg-B20">Assign Bank Limit</h4></div>
                                           <div class="col-md-3">
                                         ...
                                         if(!empty($empInfo[0]['bank'])){
                                            ...
                                            { 
                                                ...
                                                <option value="">Select Bank</option>
                                                    ...
                                                    ?>
                                                    <option value="<?=$bval->bank_id?>" <?php if( !empty($bankName[0]) && $va['bank_id']==$bankName[0]->id){ echo 'selected'; } ?> ><?=$bankName[0]->bank_name?></option>
                                                    <?php }} ?>
                                                </select>
                                            </div>
                                                    <?php  $CI =& get_instance();
                         ...
                         <div class="col-lg-3 col-md-3  showtotalLimit" style="margin-top:32px !important;display: none;">
                            ...
                            <input type="text" id="max_bank_limit" name="max_bank_limit" value="<?php if($sum!=''){ echo $sum ;}?>" class="form-control customize-form rupee-icon" placeholder="Total Limit" disabled="disabled">
...
<script type="text/javascript">    
    ...
    $('#role_id').SumoSelect({triggerChangeCombined:true,search: true, searchText: 'Search here.'});
