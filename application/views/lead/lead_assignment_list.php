                     ...
                     <form role="form" name="searchform" id="searchform">
                        <div class=" search-panel">
                           ...
                           <div class="row advnce">
                              ...
                              <div class="col-md-3 pad-R5 mrg-T20">
                           ...
                           <div class="row pad-L10 hidden">
                                <div class="col-md-1  pad-L5 pad-R5 mrg-T20">
                                 <label for="exampleInputPassword1" class="form-label">Assigned To</label>
                                 <div class="row row-text-box">
                                    <div class="col-xs-12 mrg-all-0 sm-text-box pad-all-0">
                                       <select class="form-control testselect1" name="assigned_to" id="assigned_to">
                                          <option value="">Select Sales Executive</option>
                                          <?php foreach ($execList as $ekey => $eval){  ?>
                  ...
                  <div class="pad-all-30">
                     <div class="row" >
                        ...
                        <div class="col-md-6 pad-R0" id="class-btn">
                           ...
                           <a href="JavaScript:Void(0)" id="btn_lead_assign"style="display:block" class="pull-right mrg-L15  border-L pad-L15" data-toggle="modal" data-target="#assign-lead">LEAD ASSIGNMENT RULE</a> 
                           <a href="JavaScript:Void(0)" id="btn_lead_assign_manually"style="display:block" class="pull-right mrg-L15  border-L pad-L15" data-toggle="modal" data-target="#manually_assign_list">MANUALLY ASSIGN LEADS</a> 
...
<!--                        <li role="presentation" class="<?=$noaction; ?>"><a  aria-controls="new" role="tab" data-toggle="tab" id="noaction" class="typeq">New (<span  id="noactionnew">0</span>)</a></li>
                        ...
                        <li role="presentation" class=" "><a aria-controls="assigned_leads_tab" role="tab" data-toggle="tab" id="assigned_leads_tab" class="typeq">Assigned Leads (<span  id="assigned-leads">0</span>)</a></li>
                        <li role="presentation" class=" "><a aria-controls="unassigned_leads_tab" role="tab" data-toggle="tab" id="unassigned_leads_tab" class="typeq">Unassigned Leads (<span  id="unassigned-leads">0</span>)</a></li>
                           ...
                           <div class="table-responsive">
                              <table class="table table-bordered table-striped table-hover enquiry-table mytbl">
                                 <thead>
                                    <tr>
                                       <th width="2%">
                                           <input name="assign_to_all" onclick="" type="checkbox" id="assign_to_all" value="all">
                                            <label for="assign_to_all"><span></span></label>
                                       </th>
                                       <th width="20%">Customer Details</th>
                                       <th width="20%">User Interested In</th>
                                       <th width="12%">Status</th>
                                       <th width="13%">Follow-up Date</th>
...
<div class="modal fade" id="assign-lead" role="dialog">
    <div class="modal-dialog">
        <style>
            .list-group-item{display: flex; border-radius: 4px !important; margin-bottom: 10px}
            .col-orange{opacity: 1 !important;}
            .w100{width: 100%}
            .ws{width: 93%}
            .mrg-R0{margin-right: 0 !important;}
            .oi{opacity: .54; font-style: normal !important;}
            .btn-add{ height: 40px; width: 40px; border: 1px solid #ddd; padding: 0px; display: block; font-size: 26px;text-align: center; vertical-align: middle; border-radius: 50%}
        </style>
      <!-- Modal content-->
      <div class="modal-content" id="createUser" style="width: 600px">
        <div class="modal-header modal-header-custom">
            <button id='close-lead_assign-modal' type="button" class="close" data-dismiss="modal"><img src="<?= base_url()?>assets/admin_assets/images/close-model.svg" alt="close"></button>
          <div class="row">
        ...
        <div class="modal-body" id="lead_assign_rule">
...
<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="manually_assign_list">
...
<script src="<?=base_url('assets/admin_assets/js/buy_lead_assignment.js?t='.time())?>"></script>
...
<script>
    $('.testselect1').SumoSelect({triggerChangeCombined:true,search: true, searchText: 'Search here.'});
       $('#btn_lead_assign').on('click',function(){
           
           $.ajax({
               type: 'POST',
               url: "<?= base_url()?>lead/ajax_lead_assign_rule",
               data: {},
               dataType: 'html',
               success: function (responseData, status, XMLHttpRequest) {
               $('#lead_assign_rule').html(responseData);
              }
        });
       }); 
       $('#btn_lead_assign_manually').on('click',function(){
           
           $.ajax({
               type: 'POST',
               url: "<?= base_url()?>lead/show_employee_list",
               data: {},
               dataType: 'html',
               success: function (responseData, status, XMLHttpRequest) {
               $('#show_employee_list').html(responseData);
              }
        });
       }); 
