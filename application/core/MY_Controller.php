...
class MY_Controller extends CI_Controller
{
    ...
    function loadViews($viewName = "", $headerInfo = NULL, $pageInfo = NULL, $footerInfo = NULL)
    {
        ...
        } else if (isset($headerInfo['pageType']) && $headerInfo['pageType'] == 'rcCase') {
            $this->load->view("includes/rc_transfer_left_top.php", $headerInfo);
    ...
    public function assignLeadToUser($lead_id)
    {
        ...
        if (
            !empty($rule) && empty($leadBasicData['assigned_to'])
