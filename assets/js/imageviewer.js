...
(function ($, window, document, undefined) {
    ...
    */
    ...
    var imageViewHtml = '<div class="iv-loader"></div> <div class="iv-snap-view">' + '<div class="iv-snap-image-wrap">' + '<div class="iv-snap-handle"></div>' + '</div>' + '<div class="iv-zoom-slider"><div class="iv-zoom-handle"></div></div></div>' + '<div class="iv-image-view" ><div class="iv-image-wrap"style="width:100%;height:100%" ></div></div>';
    ...
    ImageViewer.prototype = {
        ...
        load: function (image, hiResImg,image_type) {
            var self = this,
                container = this.container;
            ...
            if(image_type=='pdf'){
                snapImageWrap.prepend('<embed  src="' + image + '" type="application/pdf" height="100%" width="100%">');
                this.imageWrap.prepend('<embed  src="' + image + '" type="application/pdf" height="100%" width="100%">');
            }
            else{
            ...
            if (hiResImg) {
                 if(image_type=='pdf'){
                    //this.imageWrap.append('<embed  src="' + hiResImg + '" type="application/pdf" height="100%" width="100%">');
                }
                else{
